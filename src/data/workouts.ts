...
export const workoutData: WorkoutData = {
  ...
  saturday: {
    ...
    color: "bg-purple-500",
    exercises: [
      { id: "saturday-warmup", name: "Warm-up: Light jogging, Arm swings", duration: "2 min", muscles: "Full Body", description: "Do light jogging in place and arm swings to warm up your muscles before stretching. Warm muscles stretch better and safer!", easier: "March in place instead of jog", harder: "Add high knees and butt kicks", isWarmup: true },
      { id: "saturday-dynamic-header", name: "Dynamic Stretches", category: true, muscles: "", description: "", easier: "", harder: "" },
      { id: "saturday-leg-swings", name: "Leg Swings", duration: "30 sec each leg", muscles: "Hip Flexors, Hamstrings, Hips", description: "Hold onto a wall for balance. Swing one leg forward and backward in a controlled motion, gradually increasing the range. Then swing side to side.", easier: "Smaller swings, slower pace", harder: "Bigger swings, add circles", isStretch: true },
      { id: "saturday-arm-circles", name: "Dynamic Arm Circles", duration: "1 min", muscles: "Shoulders, Upper Back", description: "Make circles with your arms, starting small and gradually getting bigger. Do 30 seconds forward, then 30 seconds backward.", easier: "Smaller circles only", harder: "Add resistance by tensing muscles", isStretch: true },
      { id: "saturday-torso-twists", name: "Standing Torso Twists", duration: "1 min", muscles: "Obliques, Spine, Core", description: "Stand with feet shoulder-width apart. Rotate your torso left and right, letting your arms swing naturally. Keep hips facing forward.", easier: "Slower, smaller rotations", harder: "Hold a light object, twist deeper", isStretch: true },
      { id: "saturday-hip-circles", name: "Hip Circles", duration: "30 sec each direction", muscles: "Hips, Lower Back", description: "Stand with hands on hips. Make large circles with your hips, like you're hula hooping. Do clockwise, then counterclockwise.", easier: "Smaller circles", harder: "Bigger, slower circles with control", isStretch: true },
      { id: "saturday-static-header", name: "Deep Stretches", category: true, muscles: "", description: "", easier: "", harder: "" },
      { id: "saturday-forward-fold", name: "Standing Forward Fold", duration: "45 sec", muscles: "Hamstrings, Lower Back, Calves", description: "Stand with feet hip-width apart. Slowly fold forward from your hips, reaching toward your toes. Let your head hang heavy. Bend knees slightly if needed.", easier: "Bend knees more, don't reach as far", harder: "Grab behind your ankles, pull gently", isStretch: true },
      { id: "saturday-pigeon-pose", name: "Pigeon Pose", duration: "45 sec each side", muscles: "Glutes, Hip Flexors, Piriformis", description: "From all fours, bring one knee forward behind your wrist, angling your shin. Extend the other leg straight back. Lower your hips and fold forward over your front leg.", easier: "Keep torso upright, use hands for support", harder: "Fold completely forward, arms extended", isStretch: true },
      { id: "saturday-frog-stretch", name: "Frog Stretch", duration: "45 sec", muscles: "Inner Thighs, Hips, Groin", description: "Start on all fours. Slowly widen your knees as far as comfortable, keeping feet in line with knees. Lower onto your forearms and hold.", easier: "Don't go as wide, stay on hands", harder: "Go wider, lower chest toward floor", isStretch: true },
      { id: "saturday-seated-straddle", name: "Seated Straddle Stretch", duration: "45 sec", muscles: "Inner Thighs, Hamstrings, Lower Back", description: "Sit with legs spread wide in a V shape. Keep your back straight and slowly walk your hands forward, lowering your chest toward the floor.", easier: "Don't lean as far forward", harder: "Walk hands further, hold longer", isStretch: true },
      { id: "saturday-lizard-pose", name: "Lizard Pose", duration: "30 sec each side", muscles: "Hip Flexors, Hamstrings, Groin", description: "From a lunge position, place both hands inside your front foot. Lower onto your forearms if possible. Keep back leg extended.", easier: "Stay on hands, not forearms", harder: "Lower to forearms, let back knee drop", isStretch: true },
      { id: "saturday-shoulder-stretch", name: "Thread the Needle", duration: "30 sec each side", muscles: "Shoulders, Upper Back, Spine", description: "Start on all fours. Slide one arm under your body, lowering that shoulder to the floor. Reach as far as comfortable and hold.", easier: "Don't reach as far", harder: "Extend top arm overhead", isStretch: true },
      { id: "saturday-spine-header", name: "Spine Mobility", category: true, muscles: "", description: "", easier: "", harder: "" },
      { id: "saturday-cat-cow", name: "Cat-Cow Flow", duration: "1 min", muscles: "Spine, Core, Back", description: "On hands and knees, flow between arching your back up (cat) and dropping belly down while lifting head (cow). Move slowly with your breath.", easier: "Smaller movements", harder: "Hold each position for 3 breaths", isStretch: true },
      { id: "saturday-childs-pose", name: "Child's Pose", duration: "45 sec", muscles: "Lower Back, Lats, Hips", description: "Kneel down, sit back on your heels, and fold forward with arms extended. Rest your forehead on the floor and breathe deeply.", easier: "Put a pillow under chest", harder: "Walk hands to each side for lat stretch", isStretch: true },
      { id: "saturday-cobra", name: "Cobra to Downward Dog Flow", duration: "1 min", muscles: "Spine, Shoulders, Hamstrings, Calves", description: "Flow between cobra (lying face down, pressing chest up) and downward dog (inverted V shape). Move with your breath - inhale to cobra, exhale to down dog.", easier: "Stay in each pose longer, move slower", harder: "Add a plank between poses", isStretch: true },
      { id: "saturday-cooldown", name: "Cool-down: Deep breathing in Child's Pose", duration: "2 min", muscles: "Full Body Relaxation", description: "Return to child's pose. Take slow, deep breaths - inhale for 4 counts, hold for 4, exhale for 6. Let your body completely relax.", easier: "Just focus on breathing", harder: "Extend the exhale to 8 counts", isCooldown: true }
    ]
  },
  sunday: {
    name: "Sunday",
